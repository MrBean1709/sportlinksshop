<?php /* Smarty version Smarty-3.1.18, created on 2015-09-17 13:01:22
         compiled from "/opt/lampp/htdocs/sportslinkshop/design/themes/responsive/templates/pickers/categories/js.tpl" */ ?>
<?php /*%%SmartyHeaderCode:158982006255fa4922a2d159-44494398%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    'fc683afc8dc6363a7d80a68acc145566e8b47720' =>
    array (
      0 => '/opt/lampp/htdocs/sportslinkshop/design/themes/responsive/templates/pickers/categories/js.tpl',
      1 => 1441256991,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '158982006255fa4922a2d159-44494398',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_55fa4922ad5b91_59291476',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55fa4922ad5b91_59291476')) {function content_55fa4922ad5b91_59291476($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/opt/lampp/htdocs/sportslinkshop/app/lib/other/smarty/plugins/function.math.php';
...
" <?php }?>class="cm-js-item ty-p-none<?php if ($_smarty_tpl->tpl_vars['clone']->value) {?> cm-clone hidden<?php }?>">
...
" size="3" class="ty-input-text-short<?php if ($_smarty_tpl->tpl_vars['clone']->value) {?> disabled<?php }?>"<?php if ($_smarty_tpl->tpl_vars['clone']->value) {?> disabled="disabled"<?php }?> />&nbsp;<?php }?><a href="<?php echo htmlspecialchars(fn_url("categories.update?category_id=".((string)$_smarty_tpl->tpl_vars['category_id']->value)), ENT_QUOTES, 'UTF-8');?>
...
', '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_id']->value, ENT_QUOTES, 'UTF-8');?>
', 'c'); return false;" class="ty-delete-big" title="<?php echo $_smarty_tpl->__("remove");?>
"><i class="ty-delete-big__icon ty-icon-cancel-circle"></i></a>
    <?php }?>
<?php } else { ?>
    <input class="ty-input-text cm-picker-value-description" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value, ENT_QUOTES, 'UTF-8');?>
