<?php /* Smarty version Smarty-3.1.18, created on 2015-07-14 10:30:01
         compiled from "/home/lostus/public_html/sportslinkshop/design/themes/responsive/templates/addons/1clue_related_products_extended/hooks/checkout/shipping_rates.override.tpl" */ ?>
<?php /*%%SmartyHeaderCode:154884299955a39b183c29a6-71904832%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    '0962b70fb671023bb22a3686d536e912fc771754' =>
    array (
      0 => '/home/lostus/public_html/sportslinkshop/design/themes/responsive/templates/addons/1clue_related_products_extended/hooks/checkout/shipping_rates.override.tpl',
      1 => 1436840979,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '154884299955a39b183c29a6-71904832',
  'function' =>
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_55a39b18b9d231_82176094',
  'variables' =>
  array (
    'runtime' => 0,
    'show_header' => 0,
...
<?php if ($_valid && !is_callable('content_55a39b18b9d231_82176094')) {function content_55a39b18b9d231_82176094($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/lostus/public_html/sportslinkshop/app/functions/smarty_plugins/block.hook.php';
...
?><?php
fn_preload_lang_vars(array('select_shipping_method','free_shipping','free_shipping','total','free_shipping','no_shipping_required','text_no_shipping_methods','text_no_shipping_methods','no_shipping_required','free_shipping','select','select_shipping_method','free_shipping','free_shipping','total','free_shipping','no_shipping_required','text_no_shipping_methods','text_no_shipping_methods','no_shipping_required','free_shipping','select'));
?>
...
"<?php }?>>
                ...
                <?php $_smarty_tpl->tpl_vars["shippings_self_collection"] = new Smarty_variable(array(), null, 0);?>
                <?php $_smarty_tpl->tpl_vars["shippings_aramex"] = new Smarty_variable(array(), null, 0);?>
...
?>
                    <?php if ($_smarty_tpl->tpl_vars['shipping']->value['module']=="self_collection") {?>
                        <?php $_smarty_tpl->createLocalArrayVariable('shippings_self_collection', null, 0);
$_smarty_tpl->tpl_vars['shippings_self_collection']->value[] = $_smarty_tpl->tpl_vars['shipping']->value;?>
                    <?php } else { ?>
                        <?php $_smarty_tpl->createLocalArrayVariable('shippings_aramex', null, 0);
$_smarty_tpl->tpl_vars['shippings_aramex']->value[] = $_smarty_tpl->tpl_vars['shipping']->value;?>
                    <?php }?>
                <?php } ?>

                <?php if (!empty($_smarty_tpl->tpl_vars['shippings_self_collection']->value)) {?>
                    <h3>Self Collection at Outlets</h3>
                    <?php  $_smarty_tpl->tpl_vars["shipping"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["shipping"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['shippings_self_collection']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["shipping"]->key => $_smarty_tpl->tpl_vars["shipping"]->value) {
$_smarty_tpl->tpl_vars["shipping"]->_loop = true;
?>
...
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['strong_begin']->value, ENT_QUOTES, 'UTF-8');?>
                ...
                <?php if (!empty($_smarty_tpl->tpl_vars['shippings_aramex']->value)) {?>
                    <h3>Local Delivery</h3>
                    <?php  $_smarty_tpl->tpl_vars["shipping"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["shipping"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['shippings_aramex']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["shipping"]->key => $_smarty_tpl->tpl_vars["shipping"]->value) {
$_smarty_tpl->tpl_vars["shipping"]->_loop = true;
?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])) {?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A") {?><span class="cm-template-box template-box" data-ca-te-template="addons/1clue_related_products_extended/hooks/checkout/shipping_rates.override.tpl" id="<?php echo smarty_function_set_id(array('name'=>"addons/1clue_related_products_extended/hooks/checkout/shipping_rates.override.tpl"),$_smarty_tpl);?>
