<?php /* Smarty version Smarty-3.1.18, created on 2015-07-17 01:07:26
         compiled from "/home/lostus/public_html/sportslinkshop/design/themes/responsive/templates/views/theme_editor/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:149008693155a7e4ce74ddf4-63872772%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    'e6d7ba219a82372a05da5a9bd1cdaccd9659a8ab' =>
    array (
      0 => '/home/lostus/public_html/sportslinkshop/design/themes/responsive/templates/views/theme_editor/view.tpl',
      1 => 1418021496,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '149008693155a7e4ce74ddf4-63872772',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_55a7e4cf8abad6_37165583',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a7e4cf8abad6_37165583')) {function content_55a7e4cf8abad6_37165583($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/lostus/public_html/sportslinkshop/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_replace')) include '/home/lostus/public_html/sportslinkshop/app/lib/other/smarty/plugins/modifier.replace.php';
...
<div class="theme-editor <?php if ($_smarty_tpl->tpl_vars['theme_manifest']->value['converted_to_css']) {?> te-converted-to-css<?php }?>" id="theme_editor_container">
...
"><i class="ty-icon-bubble"></i></span><input type="text" class="cm-image-field" id="alt_text_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['a']->value, ENT_QUOTES, 'UTF-8');?>
...
" class="cm-combination te-advanced-options"><i class="ty-icon-cog"></i></a>
                            <?php }?>
...
" class="te-advanced-options cm-combination"><i class="ty-icon-cog"></i></a>
...
]" value="top left" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="top left") {?>checked="checked"<?php }?> /><label for="top_left"><i class="ty-icon-arrow-up-left"></i></label></div><div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="top_center" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'UTF-8');?>
]" value="top center" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="top center") {?>checked="checked"<?php }?> /><label for="top_center"><i class="ty-icon-arrow-up"></i></label></div><div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="top_right" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'UTF-8');?>
]" value="top right" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="top right") {?>checked="checked"<?php }?> /><label for="top_right"><i class="ty-icon-arrow-up-right"></i></label></div>
                                    </div>
                                    <div class="te-bg-position-wrap clearfix">
...
]" if="center_left" value="center left" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="center left") {?>checked="checked"<?php }?> /><label for="center_left"><i class="ty-icon-arrow-left"></i></label></div><div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="center_center" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'UTF-8');?>
]" value="center center" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="center center") {?>checked="checked"<?php }?> /><label for="center_center"><i class="ty-icon-square"></i></label></div><div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="center_right" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'UTF-8');?>
]" value="center right" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="center right") {?>checked="checked"<?php }?> /><label for="center_right"><i class="ty-icon-arrow-right"></i></label></div>
                                    </div>
                                    <div class="te-bg-position-wrap clearfix">
...
]" value="bottom left" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="bottom left") {?>checked="checked"<?php }?> /><label for="bottom_left"><i class="ty-icon-arrow-down-left"></i></label></div><div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="bottom_center" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'UTF-8');?>
]" value="bottom center" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="bottom center") {?>checked="checked"<?php }?> /><label for="bottom_center"><i class="ty-icon-arrow-down"></i></label></div><div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="bottom_right" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'UTF-8');?>
]" value="bottom right" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="bottom right") {?>checked="checked"<?php }?> /><label for="bottom_right"><i class="ty-icon-arrow-down-right"></i></label></div>
                                    </div>
                                </div>
                            </div>
                        <?php }?>
