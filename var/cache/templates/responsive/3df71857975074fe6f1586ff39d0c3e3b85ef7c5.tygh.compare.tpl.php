<?php /* Smarty version Smarty-3.1.18, created on 2015-06-11 23:53:54
         compiled from "/home/lostus/public_html/sportslinkshop/design/themes/responsive/templates/views/product_features/compare.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6209595125579af12c1ad94-64868096%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    '3df71857975074fe6f1586ff39d0c3e3b85ef7c5' =>
    array (
      0 => '/home/lostus/public_html/sportslinkshop/design/themes/responsive/templates/views/product_features/compare.tpl',
      1 => 1418021496,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '6209595125579af12c1ad94-64868096',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_5579af132649f3_49990205',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5579af132649f3_49990205')) {function content_5579af132649f3_49990205($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/home/lostus/public_html/sportslinkshop/app/functions/smarty_plugins/function.script.php';
...
?>
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C") {?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><?php if (!$_smarty_tpl->tpl_vars['comparison_data']->value) {?>
...
<?php }?><?php if ($_smarty_tpl->tpl_vars['feature']->value['feature_type']=="C") {?><span class="ty-compare-checkbox" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['value'], ENT_QUOTES, 'UTF-8');?>
...
<?php } elseif ($_smarty_tpl->tpl_vars['feature']->value['feature_type']=="M"&&$_smarty_tpl->tpl_vars['feature']->value['variants']) {?><ul class="ty-compare-list"><?php  $_smarty_tpl->tpl_vars["var"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["var"]->_loop = false;
...
?><?php if ($_smarty_tpl->tpl_vars['var']->value['selected']) {?><li class="ty-compare-list__item"><span class="ty-compare-checkbox" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['variant'], ENT_QUOTES, 'UTF-8');?>
...
<?php }?><?php }?><?php } else { ?><?php if (!$_smarty_tpl->tpl_vars['comparison_data']->value) {?>
    <p class="ty-no-items ty-compare__no-items"><?php echo $_smarty_tpl->__("no_products_selected");?>
</p>
    <div class="buttons-container ty-compare__button-empty">
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/continue_shopping.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_href'=>fn_url($_smarty_tpl->tpl_vars['continue_url']->value),'but_role'=>"text"), 0);?>
