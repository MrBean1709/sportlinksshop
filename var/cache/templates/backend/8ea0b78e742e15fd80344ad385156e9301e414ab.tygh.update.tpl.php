<?php /* Smarty version Smarty-3.1.18, created on 2015-06-13 08:04:25
         compiled from "/home/lostus/public_html/sportslinkshop/design/backend/templates/views/categories/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:278878385557b7389639536-31603224%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    '8ea0b78e742e15fd80344ad385156e9301e414ab' =>
    array (
      0 => '/home/lostus/public_html/sportslinkshop/design/backend/templates/views/categories/update.tpl',
      1 => 1418020416,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '278878385557b7389639536-31603224',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_557b7389aeaff3_84694458',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_557b7389aeaff3_84694458')) {function content_557b7389aeaff3_84694458($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/lostus/public_html/sportslinkshop/app/functions/smarty_plugins/block.hook.php';
?><?php
fn_preload_lang_vars(array('information','name','location','root_level','location','root_level','description','images','text_category_icon','text_category_detailed_image','seo_meta_data','page_title','ttc_page_title','meta_description','meta_keywords','availability','usergroups','to_all_subcats','position','creation_date','product_details_view','use_custom_view','product_columns','available_views','default_category_view','add_subcategory','add_product','preview','view_products','category_deletion_side_effects','delete_this_category','categories','new_category','editing_category'));
?>
...
" <?php if (($_smarty_tpl->tpl_vars['category_data']->value['selected_layouts'][$_smarty_tpl->tpl_vars['layout']->value])||(!$_smarty_tpl->tpl_vars['category_data']->value['selected_layouts']&&$_smarty_tpl->tpl_vars['item']->value['active'])) {?>checked="checked"<?php }?> <?php if (!$_smarty_tpl->tpl_vars['category_data']->value['selected_layouts']) {?>disabled="disabled"<?php }?> /><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['title'], ENT_QUOTES, 'UTF-8');?>
        ...
        <div class="control-group">
            <label class="control-label" for="elm_category_default_layout"><?php echo $_smarty_tpl->__("default_category_view");?>
:</label>
            <div class="controls">
...
<?php $_tmp1=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'class'=>"cm-confirm",'text'=>__("delete_this_category"),'data'=>array("data-ca-confirm-text"=>$_tmp1),'href'=>"categories.delete?category_id=".((string)$_smarty_tpl->tpl_vars['id']->value)));?>
</li>
...
<?php $_tmp2=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('sidebar'=>Smarty::$_smarty_vars['capture']['sidebar'],'sidebar_position'=>"left",'title'=>$_tmp2.": ".((string)$_smarty_tpl->tpl_vars['category_data']->value['category']),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'select_languages'=>true,'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons']), 0);?>
