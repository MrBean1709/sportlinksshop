<?php /* Smarty version Smarty-3.1.18, created on 2015-07-13 12:24:16
         compiled from "/home/lostus/public_html/sportslinkshop/design/backend/templates/addons/1clue_related_products_extended/overrides/views/orders/details.tpl" */ ?>
<?php /*%%SmartyHeaderCode:200323527355a33d70b92730-71175660%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    '2d40ed46bd833fec1c82638e6f94110d1b60626f' =>
    array (
      0 => '/home/lostus/public_html/sportslinkshop/design/backend/templates/addons/1clue_related_products_extended/overrides/views/orders/details.tpl',
      1 => 1436761328,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '200323527355a33d70b92730-71175660',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_55a33d715877d4_75791863',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a33d715877d4_75791863')) {function content_55a33d715877d4_75791863($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/lostus/public_html/sportslinkshop/app/functions/smarty_plugins/block.hook.php';
...
&nbsp;<?php echo $_smarty_tpl->__("shipped");?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['order_info']->value['use_discount']) {?>
                <td class="nowrap">
                    <?php if (floatval($_smarty_tpl->tpl_vars['oi']->value['extra']['discount'])) {?><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['oi']->value['extra']['discount']), 0);?>
<?php } else { ?>-<?php }?></td>
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['order_info']->value['taxes']&&$_smarty_tpl->tpl_vars['settings']->value['General']['tax_calculation']!="subtotal") {?>
                <td class="nowrap">
                    <?php if (floatval($_smarty_tpl->tpl_vars['oi']->value['tax_value'])) {?><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['oi']->value['tax_value']), 0);?>
<?php } else { ?>-<?php }?></td>
                <?php }?>
...
?>
                        <div class="control-group">
                            <?php if ($_smarty_tpl->tpl_vars['item']->value&&$_smarty_tpl->tpl_vars['key']->value!="expiry_year") {?>
                                <div class="control-label">
                                <?php if ($_smarty_tpl->tpl_vars['key']->value=="card_number") {?><?php $_smarty_tpl->tpl_vars["cc_exists"] = new Smarty_variable(true, null, 0);?><?php echo $_smarty_tpl->__("credit_card");?>
<?php } elseif ($_smarty_tpl->tpl_vars['key']->value=="expiry_month") {?><?php echo $_smarty_tpl->__("expiry_date");?>
<?php } else { ?><?php echo $_smarty_tpl->__($_smarty_tpl->tpl_vars['key']->value);?>
<?php }?>
                                </div>
                                <div class="controls">
...
?>
                        ...
                        <div class="control-group">
                            <?php if ($_smarty_tpl->tpl_vars['shipping']->value['module']=="self_collection") {?>
                                <div class="control-label">Self Pickup</div>
                                ...
                                <div class="control-label">Outlet Name</div>
                                <div class="controls">
                                    <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['shipping']->value['service_params']['outlet_name'])===null||$tmp==='' ? 'none' : $tmp), ENT_QUOTES, 'UTF-8');?>

                                </div>
                                <div class="control-label">Location</div>
                                <div class="controls">
                                    <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['shipping']->value['service_params']['location'])===null||$tmp==='' ? 'none' : $tmp), ENT_QUOTES, 'UTF-8');?>

                                </div>
                                <div class="control-label">Address</div>
                                <div class="controls">
                                    <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['shipping']->value['service_params']['address'])===null||$tmp==='' ? 'none' : $tmp), ENT_QUOTES, 'UTF-8');?>
...
?>
        <tr>
            ...
            <td>
                <?php if ($_smarty_tpl->tpl_vars['file']->value['activation_type']=="M") {?><?php echo $_smarty_tpl->__("manually");?>
</label><?php } elseif ($_smarty_tpl->tpl_vars['file']->value['activation_type']=="I") {?><?php echo $_smarty_tpl->__("immediately");?>
<?php } else { ?><?php echo $_smarty_tpl->__("after_full_payment");?>
<?php }?>
            </td>
            <td><?php if ($_smarty_tpl->tpl_vars['file']->value['max_downloads']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['file']->value['max_downloads'], ENT_QUOTES, 'UTF-8');?>
...
" size="3" /><?php } else { ?><?php echo $_smarty_tpl->__("none");?>
<?php }?></td>
            <td>
...
: </label><?php echo $_smarty_tpl->getSubTemplate ("common/calendar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('date_id'=>"prolongate_date_".((string)$_smarty_tpl->tpl_vars['file']->value['file_id']),'date_name'=>"prolongate_data[".((string)$_smarty_tpl->tpl_vars['file']->value['ekey'])."]",'date_val'=>(($tmp = @$_smarty_tpl->tpl_vars['file']->value['ttl'])===null||$tmp==='' ? @constant('TIME') : $tmp),'start_year'=>$_smarty_tpl->tpl_vars['settings']->value['Company']['company_start_year']), 0);?>
                ...
                <?php } else { ?><?php echo $_smarty_tpl->__("file_doesnt_have_key");?>
<?php }?>
            </td>
            <td>
