<?php /* Smarty version Smarty-3.1.18, created on 2015-09-17 11:44:20
         compiled from "/opt/lampp/htdocs/sportslinkshop/design/backend/templates/views/order_management/components/products.tpl" */ ?>
<?php /*%%SmartyHeaderCode:61927090455fa37142ded21-82192208%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    '2eaca6c3311ce4e33b9998e567df71fe24560dc4' =>
    array (
      0 => '/opt/lampp/htdocs/sportslinkshop/design/backend/templates/views/order_management/components/products.tpl',
      1 => 1441256926,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '61927090455fa37142ded21-82192208',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_55fa3714394cb7_32623022',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55fa3714394cb7_32623022')) {function content_55fa3714394cb7_32623022($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/opt/lampp/htdocs/sportslinkshop/app/functions/smarty_plugins/block.hook.php';
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"order_management:products_extra_items"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
">
            <?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['cp']->value['base_price'],'view'=>"input",'input_name'=>"cart_products[".((string)$_smarty_tpl->tpl_vars['key']->value)."][price]",'class'=>"input-hidden input-mini"), 0);?>
...
--></span>
    ...
    <td class="nowrap">
        <div class="hidden-tools">
            <a class="cm-confirm icon-trash" href="<?php echo htmlspecialchars(fn_url("order_management.delete?cart_id=".((string)$_smarty_tpl->tpl_vars['key']->value)), ENT_QUOTES, 'UTF-8');?>
