<?php /* Smarty version Smarty-3.1.18, created on 2015-07-21 01:54:18
         compiled from "/home/lostus/public_html/sportslinkshop/design/backend/templates/views/categories/m_add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:179672681455ad35ca8bd197-41637512%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    '06dc181e1e1adfb3d94f137e146dd6c0ff508d67' =>
    array (
      0 => '/home/lostus/public_html/sportslinkshop/design/backend/templates/views/categories/m_add.tpl',
      1 => 1418020416,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '179672681455ad35ca8bd197-41637512',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_55ad35cab5bd96_39732337',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55ad35cab5bd96_39732337')) {function content_55ad35cab5bd96_39732337($_smarty_tpl) {?><?php
...
<tr id="box_new_cat_tag">
    <td>
        <?php if (fn_show_picker("categories",@constant('CATEGORY_THRESHOLD'))) {?>
            <?php echo $_smarty_tpl->getSubTemplate ("pickers/categories/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('data_id'=>"location_category",'input_name'=>"categories_data[0][parent_id]",'item_ids'=>0,'hide_link'=>true,'hide_delete_button'=>true,'default_name'=>__("root_level")), 0);?>

        <?php } else { ?>
            <?php echo $_smarty_tpl->getSubTemplate ("common/select_category.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('name'=>"categories_data[0][parent_id]",'select_class'=>"input-medium",'root_text'=>__("root_level"),'id'=>''), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>__("add_categories"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons']), 0);?>
