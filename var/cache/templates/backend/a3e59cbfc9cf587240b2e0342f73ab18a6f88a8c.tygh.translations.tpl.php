<?php /* Smarty version Smarty-3.1.18, created on 2015-06-08 17:08:52
         compiled from "/home/lostus/public_html/sportslinkshop/design/backend/templates/views/languages/translations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:213306342055755ba49eac75-77815860%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    'a3e59cbfc9cf587240b2e0342f73ab18a6f88a8c' =>
    array (
      0 => '/home/lostus/public_html/sportslinkshop/design/backend/templates/views/languages/translations.tpl',
      1 => 1418020417,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '213306342055755ba49eac75-77815860',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_55755ba4b8ef42_35624853',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55755ba4b8ef42_35624853')) {function content_55755ba4b8ef42_35624853($_smarty_tpl) {?><?php
fn_preload_lang_vars(array('value','language_variable','delete','restore_default','no_data','language_variable','value','new_language_variable','add_language_variable','on_site_live_editing','translations'));
?>
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php $_smarty_tpl->_capture_stack[0][] = array("add_button", null, null); ob_start(); ?>
        ...
        <span class="cm-tab-tools btn-group" id="tools_translations_save_button">
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/save.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_name'=>"dispatch[languages.m_update_variables]",'but_role'=>"submit-link",'but_target_form'=>"language_variables_form"), 0);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("adv_buttons", null, null); ob_start(); ?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"add_langvar",'text'=>__("new_language_variable"),'title'=>__("add_language_variable"),'content'=>Smarty::$_smarty_vars['capture']['add_langvar'],'act'=>"general",'icon'=>"icon-plus"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>__("translations"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons'],'sidebar'=>Smarty::$_smarty_vars['capture']['sidebar'],'select_languages'=>true), 0);?>
