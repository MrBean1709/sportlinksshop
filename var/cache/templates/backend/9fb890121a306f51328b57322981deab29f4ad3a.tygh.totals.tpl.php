<?php /* Smarty version Smarty-3.1.18, created on 2015-09-17 11:44:20
         compiled from "/opt/lampp/htdocs/sportslinkshop/design/backend/templates/views/order_management/components/totals.tpl" */ ?>
<?php /*%%SmartyHeaderCode:89493723455fa37149b0066-27059797%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    '9fb890121a306f51328b57322981deab29f4ad3a' =>
    array (
      0 => '/opt/lampp/htdocs/sportslinkshop/design/backend/templates/views/order_management/components/totals.tpl',
      1 => 1441256925,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '89493723455fa37149b0066-27059797',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_55fa3714a6aaf6_79493444',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55fa3714a6aaf6_79493444')) {function content_55fa3714a6aaf6_79493444($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/opt/lampp/htdocs/sportslinkshop/app/functions/smarty_plugins/block.hook.php';
?><?php
fn_preload_lang_vars(array('totals','subtotal','including_discount','order_discount','manually_set_tax_rates','included','coupon','payment_surcharge','total_cost','recalculate_totals'));
?>
<div class="pull-right order-notes statistic">
    <table>
        <tr>
            <td>&nbsp;</td>
            <td class="right totals"><h4><?php echo $_smarty_tpl->__("totals");?>
</h4></td>
        </tr>
        <tr>
            <td class="right" width="150px"><?php echo $_smarty_tpl->__("subtotal");?>
:</td>
        ...
        <?php if ((floatval($_smarty_tpl->tpl_vars['cart']->value['discount']))) {?>
            <tr>
                <td class="right"><?php echo $_smarty_tpl->__("including_discount");?>
:</td>
...
?>
        <tr class="toggle-elm nowrap">
            <td class="right">&nbsp;<span>&middot;</span>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tax']->value['description'], ENT_QUOTES, 'UTF-8');?>
<?php if ($_smarty_tpl->tpl_vars['tax']->value['price_includes_tax']=="Y"&&$_smarty_tpl->tpl_vars['settings']->value['Appearance']['cart_prices_w_taxes']!="Y") {?>&nbsp;<?php echo $_smarty_tpl->__("included");?>
<?php }?>(<span <?php if ($_smarty_tpl->tpl_vars['cart']->value['stored_taxes']=="Y") {?>class="hidden"<?php }?> data-ca-switch-id="manual_taxes"><?php echo $_smarty_tpl->getSubTemplate ("common/modifier.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('mod_value'=>$_smarty_tpl->tpl_vars['tax']->value['rate_value'],'mod_type'=>$_smarty_tpl->tpl_vars['tax']->value['rate_type']), 0);?>
...
">
    ...
    <?php if ($_smarty_tpl->tpl_vars['cart']->value['coupons']) {?>
        <input type="hidden" name="c_id" value="0" id="c_id" />
        <tr>
            <td class="right muted strong"><?php echo $_smarty_tpl->__("coupon");?>
:</td>
            <td>&nbsp;</td>
        </tr>
...
?>
            <tr>
                <td class="right"> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8');?>
&nbsp;
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_href'=>"order_management.delete_coupon?c_id=".((string)$_smarty_tpl->tpl_vars['key']->value),'but_icon'=>"icon-trash",'but_role'=>"delete_item",'but_meta'=>"cm-ajax",'but_target_id'=>$_smarty_tpl->tpl_vars['result_ids']->value), 0);?>
</td>
                <td class="right">&nbsp;</td>
            </tr>
        <?php } ?>
    ...
    <tr id="payment_surcharge_line">
        <td class="right"><?php echo $_smarty_tpl->__("payment_surcharge");?>
</td>
...
$_smarty_tpl->tpl_vars['cart']->value['total'] = $_smarty_tpl->tpl_vars['cart']->value['total']+$_smarty_tpl->tpl_vars['cart']->value['payment_surcharge'];?>
    ...
    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"order_management:totals"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <tr class="total nowrap cm-om-totals-price">
            <td class="right"><h4><?php echo $_smarty_tpl->__("total_cost");?>
</h4></td>
