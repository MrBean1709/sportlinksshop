<?php /* Smarty version Smarty-3.1.18, created on 2015-09-17 12:04:26
         compiled from "/opt/lampp/htdocs/sportslinkshop/design/backend/mail/templates/orders/invoice.tpl" */ ?>
<?php /*%%SmartyHeaderCode:204364023855fa3bcae1d6b0-46495836%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    'f327851105ad49ef51706803daa5eefc37908e99' =>
    array (
      0 => '/opt/lampp/htdocs/sportslinkshop/design/backend/mail/templates/orders/invoice.tpl',
      1 => 1441256882,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '204364023855fa3bcae1d6b0-46495836',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_55fa3bcb37de05_85149489',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55fa3bcb37de05_85149489')) {function content_55fa3bcb37de05_85149489($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/opt/lampp/htdocs/sportslinkshop/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_replace')) include '/opt/lampp/htdocs/sportslinkshop/app/lib/other/smarty/plugins/modifier.replace.php';
...
<?php $_tmp5=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["doc_id_text"] = new Smarty_variable($_tmp5." #".((string)$_smarty_tpl->tpl_vars['order_info']->value['doc_ids'][$_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']]), null, 0);?>
...
<?php $_tmp6=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["doc_id_text"] = new Smarty_variable($_tmp6." #".((string)$_smarty_tpl->tpl_vars['order_info']->value['doc_ids'][$_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']]), null, 0);?>
...
$_smarty_tpl->tpl_vars["shipping"]->_loop = true;
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']["f_shipp"]['last'] = $_smarty_tpl->tpl_vars["shipping"]->last;
?>
                                    <?php if ($_smarty_tpl->tpl_vars['shipments']->value[$_smarty_tpl->tpl_vars['shipping']->value['group_key']]['tracking_number']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipments']->value[$_smarty_tpl->tpl_vars['shipping']->value['group_key']]['tracking_number'], ENT_QUOTES, 'UTF-8');?>
<?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['f_shipp']['last']) {?>,<?php }?><?php }?>
                                <?php } ?></td>
                        </tr>
                    <?php }?>
                    <?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']=="I"&&$_smarty_tpl->tpl_vars['order_info']->value['doc_ids'][$_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']]) {?>
    <?php ob_start();?><?php echo $_smarty_tpl->__("invoice");?>
<?php $_tmp7=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["doc_id_text"] = new Smarty_variable($_tmp7." #".((string)$_smarty_tpl->tpl_vars['order_info']->value['doc_ids'][$_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']]), null, 0);?>
<?php } elseif ($_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']=="C"&&$_smarty_tpl->tpl_vars['order_info']->value['doc_ids'][$_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']]) {?>
    <?php ob_start();?><?php echo $_smarty_tpl->__("credit_memo");?>
<?php $_tmp8=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["doc_id_text"] = new Smarty_variable($_tmp8." #".((string)$_smarty_tpl->tpl_vars['order_info']->value['doc_ids'][$_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']]), null, 0);?>
    <?php $_smarty_tpl->tpl_vars["order_header"] = new Smarty_variable($_smarty_tpl->__("credit_memo"), null, 0);?>
<?php } elseif ($_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']=="O") {?>
    <?php $_smarty_tpl->tpl_vars["order_header"] = new Smarty_variable($_smarty_tpl->__("order_details"), null, 0);?>
<?php }?>
