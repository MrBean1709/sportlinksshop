<?php /* Smarty version Smarty-3.1.18, created on 2015-07-03 22:16:42
         compiled from "/home/lostus/public_html/sportslinkshop/design/backend/templates/views/promotions/components/group.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1431040355596994adcbb74-81879768%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    'a9c04209a8f2c2663152050eab12961c001aea63' =>
    array (
      0 => '/home/lostus/public_html/sportslinkshop/design/backend/templates/views/promotions/components/group.tpl',
      1 => 1418020420,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1431040355596994adcbb74-81879768',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_5596994b00d826_25666819',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5596994b00d826_25666819')) {function content_5596994b00d826_25666819($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_in_array')) include '/home/lostus/public_html/sportslinkshop/app/functions/smarty_plugins/modifier.in_array.php';
?><?php
fn_preload_lang_vars(array('promotions.cond_any','promotions.cond_all','promotions.cond_all','promotions.cond_any','promotions.cond_true','promotions.cond_false','promotions.cond_false','promotions.cond_true','remove_this_item','add_condition','add_group','text_promotions_group_condition','no_items'));
?>
...
<?php }?>
<?php echo $_smarty_tpl->getSubTemplate ("common/select_object.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('style'=>"field",'items'=>array("all"=>__("promotions.cond_all"),"any"=>__("promotions.cond_any")),'select_container_name'=>((string)$_smarty_tpl->tpl_vars['prefix']->value)."[set]",'selected_key'=>$_smarty_tpl->tpl_vars['group']->value['set'],'selected_name'=>$_smarty_tpl->tpl_vars['selected_name']->value), 0);?>
...
" class="btn-toolbar pull-right">
            <?php if (!$_smarty_tpl->tpl_vars['hide_add_buttons']->value) {?>
                <?php echo $_smarty_tpl->getSubTemplate ("common/tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('hide_tools'=>true,'tool_onclick'=>"fn_promotion_add(Tygh."."$"."(this).parents('div[id^=add_condition_]').prop('id'), false, 'condition');",'prefix'=>"simple",'link_text'=>__("add_condition")), 0);?>

                <?php echo $_smarty_tpl->getSubTemplate ("common/tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('hide_tools'=>true,'tool_onclick'=>"fn_promotion_add_group(Tygh."."$"."(this).parents('div[id^=add_condition_]').prop('id'), '".((string)$_smarty_tpl->tpl_vars['zone']->value)."');",'prefix'=>"simple",'link_text'=>__("add_group")), 0);?>
