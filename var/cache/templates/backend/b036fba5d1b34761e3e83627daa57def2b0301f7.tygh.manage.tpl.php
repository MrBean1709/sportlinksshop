<?php /* Smarty version Smarty-3.1.18, created on 2015-06-19 18:34:23
         compiled from "/home/lostus/public_html/sportslinkshop/design/backend/templates/addons/call_requests/views/call_requests/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8422312535583f02f2fe619-89159245%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    'b036fba5d1b34761e3e83627daa57def2b0301f7' =>
    array (
      0 => '/home/lostus/public_html/sportslinkshop/design/backend/templates/addons/call_requests/views/call_requests/manage.tpl',
      1 => 1418020410,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '8422312535583f02f2fe619-89159245',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_5583f02f64ed68_39250575',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5583f02f64ed68_39250575')) {function content_5583f02f64ed68_39250575($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/lostus/public_html/sportslinkshop/app/functions/smarty_plugins/modifier.date_format.php';
?><?php
...
<?php if ($_smarty_tpl->tpl_vars['search']->value['sort_by']=="order") {?><?php echo $_smarty_tpl->tpl_vars['c_icon']->value;?>
<?php }?></a>
                /
...
<?php if ($_smarty_tpl->tpl_vars['search']->value['sort_by']=="order_status") {?><?php echo $_smarty_tpl->tpl_vars['c_icon']->value;?>
<?php }?></a>
            </th>
            <th width="10%">
...
<?php if ($_smarty_tpl->tpl_vars['search']->value['sort_by']=="user") {?><?php echo $_smarty_tpl->tpl_vars['c_icon']->value;?>
<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['c_dummy']->value;?>
<?php }?></a>
            </th>
            <th width="5%">&nbsp;</th>
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['order_id'], ENT_QUOTES, 'UTF-8');?>
<?php }?>" class="input-micro input-hidden right" />
                ...
                <td class="nowrap">
                    <div class="hidden-tools">
                        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete"),'href'=>"call_requests.delete?request_id=".((string)$_smarty_tpl->tpl_vars['request']->value['request_id']),'class'=>"cm-confirm"));?>
</li>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>__("call_requests"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'sidebar'=>Smarty::$_smarty_vars['capture']['sidebar']), 0);?>
<?php }} ?>
