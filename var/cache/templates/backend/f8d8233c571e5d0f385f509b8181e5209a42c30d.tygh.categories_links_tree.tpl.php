<?php /* Smarty version Smarty-3.1.18, created on 2015-06-13 08:04:26
         compiled from "/home/lostus/public_html/sportslinkshop/design/backend/templates/views/categories/components/categories_links_tree.tpl" */ ?>
<?php /*%%SmartyHeaderCode:267057499557b738a012337-27793850%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    'f8d8233c571e5d0f385f509b8181e5209a42c30d' =>
    array (
      0 => '/home/lostus/public_html/sportslinkshop/design/backend/templates/views/categories/components/categories_links_tree.tpl',
      1 => 1418020416,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '267057499557b738a012337-27793850',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_557b738a0f7728_41088943',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_557b738a0f7728_41088943')) {function content_557b738a0f7728_41088943($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_in_array')) include '/home/lostus/public_html/sportslinkshop/app/functions/smarty_plugins/modifier.in_array.php';
?><?php
...
?>
    ...
    <?php $_smarty_tpl->_capture_stack[0][] = array("category_subtitle", null, null); ob_start(); ?>
        ...
        <?php } else { ?>
            ...
            <?php } else { ?>
                <a class="row-status <?php if ($_smarty_tpl->tpl_vars['category']->value['status']=="N") {?> manage-root-item-disabled<?php }?><?php if (!$_smarty_tpl->tpl_vars['category']->value['subcategories']) {?> normal<?php }?>" href="<?php echo htmlspecialchars(fn_url("categories.update?category_id=".((string)$_smarty_tpl->tpl_vars['category']->value['category_id'])), ENT_QUOTES, 'UTF-8');?>
...
" class="cm-combination<?php if (!$_smarty_tpl->tpl_vars['expanded']->value) {?> hidden<?php }?>" ><span class="exicon-collapse"> </span></span><?php }?><?php echo Smarty::$_smarty_vars['capture']['category_subtitle'];?>
</div>
    </li>
