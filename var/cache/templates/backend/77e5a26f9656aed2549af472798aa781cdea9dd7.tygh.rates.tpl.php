<?php /* Smarty version Smarty-3.1.18, created on 2015-06-13 06:16:05
         compiled from "/home/lostus/public_html/sportslinkshop/design/backend/templates/views/shippings/components/rates.tpl" */ ?>
<?php /*%%SmartyHeaderCode:748959611557b5a2560d3d0-16508177%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    '77e5a26f9656aed2549af472798aa781cdea9dd7' =>
    array (
      0 => '/home/lostus/public_html/sportslinkshop/design/backend/templates/views/shippings/components/rates.tpl',
      1 => 1418020420,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '748959611557b5a2560d3d0-16508177',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_557b5a25acae25_26410171',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_557b5a25acae25_26410171')) {function content_557b5a25acae25_26410171($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/lostus/public_html/sportslinkshop/app/functions/smarty_plugins/block.hook.php';
?><?php
...
<div class="dashboard-shipping tabs cm-j-tabs" data-ca-width="760" id="dashboard-shipping">
    ...
    <p><?php echo $_smarty_tpl->__("show_rate_for_destination");?>
:</p>
...
<?php if ($_smarty_tpl->tpl_vars['rate']->value['rate_defined']) {?>(+)<?php }?></a>
            </li>
        <?php } ?>
    </ul>
    <?php }?>
...
?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['shipping']->value['rate_calculation']=="M") {?>
            <?php $_smarty_tpl->tpl_vars["destination_id"] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['rate_data']->value['destination_id']), null, 0);?>
        <?php } else { ?>
...
">
            <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>__("cost_dependences"),'meta'=>"clear"), 0);?>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"shippings:cost_dependences_head"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</th>
                    <th>&nbsp;</th>
                </tr>
                </thead>
...
][rate_value][C][<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']) {?>0<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8');?>
<?php }?>][value]" size="5" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['rate']->value['value'])===null||$tmp==='' ? "0" : $tmp), ENT_QUOTES, 'UTF-8');?>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"shippings:cost_dependences_body"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</td>
                        <td class="nowrap right">
                            <?php $_smarty_tpl->_capture_stack[0][] = array("tools_items", null, null); ob_start(); ?>

                                <?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']&&fn_allow_save_object($_smarty_tpl->tpl_vars['shipping']->value,"shippings")) {?>
                                    <a class="cm-confirm cm-tooltip" href="<?php echo htmlspecialchars(fn_url("shippings.delete_rate_value?rate_type=C&amount=".((string)$_smarty_tpl->tpl_vars['k']->value)."&shipping_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&destination_id=".((string)$_smarty_tpl->tpl_vars['destination_id']->value)."&rate_id=".((string)$_smarty_tpl->tpl_vars['rate_data']->value['rate_id'])), ENT_QUOTES, 'UTF-8');?>
" title="<?php echo $_smarty_tpl->__("delete");?>
"><i class="icon-trash"></i></a>
                                <?php } else { ?>
                                    <span class="icon-trash undeleted-element" <?php echo $_smarty_tpl->__("delete");?>
></span>
                                <?php }?>
...
&nbsp;<?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>'','view'=>"input",'input_name'=>"shipping_data[add_rates][".((string)$_smarty_tpl->tpl_vars['destination_id']->value)."][rate_value][C][0][amount]",'class'=>"input-small input-hidden"), 0);?>
 ...
 (%)</option>
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>__("weight_dependences"),'meta'=>"clear"), 0);?>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"shippings:weight_dependences_head"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</th>
                    <th>&nbsp;</th>
                </tr>
                </thead>
...
][amount]" data-p-sign="s" data-a-sign=" <?php echo $_smarty_tpl->tpl_vars['settings']->value['General']['weight_symbol'];?>
...
" class="cm-numeric input-small input-hidden" />
                        ...
                        <td>
                            <input type="text" name="shipping_data[rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'UTF-8');?>
][rate_value][W][<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']) {?>0<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8');?>
<?php }?>][value]" size="5" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['rate']->value['value'])===null||$tmp==='' ? "0" : $tmp), ENT_QUOTES, 'UTF-8');?>
" class="input-small input-hidden" /></td>
                        <td>
                            <select class="input-medium" name="shipping_data[rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'UTF-8');?>
...
<?php }?>][per_unit]" value="Y" <?php if ($_smarty_tpl->tpl_vars['rate']->value['per_unit']=="Y") {?>checked="checked"<?php }?> class="checkbox" />
                        </td>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"shippings:weight_dependences_body"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</td>
                        <td class="nowrap right">
                            <?php $_smarty_tpl->_capture_stack[0][] = array("tools_items", null, null); ob_start(); ?>

                                <?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']&&fn_allow_save_object($_smarty_tpl->tpl_vars['shipping']->value,"shippings")) {?>
                                    <a class="cm-confirm cm-tooltip" href="<?php echo htmlspecialchars(fn_url("shippings.delete_rate_value?rate_type=W&amount=".((string)$_smarty_tpl->tpl_vars['k']->value)."&shipping_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&destination_id=".((string)$_smarty_tpl->tpl_vars['destination_id']->value)."&rate_id=".((string)$_smarty_tpl->tpl_vars['rate_data']->value['rate_id'])), ENT_QUOTES, 'UTF-8');?>
" title="<?php echo $_smarty_tpl->__("delete");?>
"><i class="icon-trash"></i></a>
                                <?php } else { ?>
                                    <span class="icon-trash undeleted-element" <?php echo $_smarty_tpl->__("delete");?>
...
">
                        ...
                        <td>
                            <?php echo $_smarty_tpl->__("more_than");?>
&nbsp; <input type="text" name="shipping_data[add_rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'UTF-8');?>
][rate_value][W][0][amount]" data-p-sign="s" data-a-sign=" <?php echo $_smarty_tpl->tpl_vars['settings']->value['General']['weight_symbol'];?>
" size="5" value="" class="cm-numeric input-small input-hidden" /></td>
 ...
 (%)</option>
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>__("items_dependences"),'meta'=>"clear"), 0);?>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"shippings:items_dependences_head"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</th>
                    <th>&nbsp;</th>
                </tr>
                </thead>
...
" class="cm-numeric input-small input-hidden" />
                        ...
                        <td>
                            <input type="text" name="shipping_data[rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'UTF-8');?>
][rate_value][I][<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']) {?>0<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8');?>
<?php }?>][value]" size="5" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['rate']->value['value'])===null||$tmp==='' ? "0" : $tmp), ENT_QUOTES, 'UTF-8');?>
" class="input-small input-hidden" /></td>
                        <td>
                            <select class="input-medium" name="shipping_data[rates][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'UTF-8');?>
...
<?php }?>][per_unit]" value="Y" class="checkbox" <?php if ($_smarty_tpl->tpl_vars['rate']->value['per_unit']=="Y") {?>checked="checked"<?php }?> />
                        </td>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"shippings:items_dependences_body"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</td>
                        <td class="nowrap right">
                            <?php $_smarty_tpl->_capture_stack[0][] = array("tools_items", null, null); ob_start(); ?>

                                <?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']&&fn_allow_save_object($_smarty_tpl->tpl_vars['shipping']->value,"shippings")) {?>
                                    <a class="cm-confirm cm-tooltip" href="<?php echo htmlspecialchars(fn_url("shippings.delete_rate_value?rate_type=I&amount=".((string)$_smarty_tpl->tpl_vars['k']->value)."&shipping_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&destination_id=".((string)$_smarty_tpl->tpl_vars['destination_id']->value)."&rate_id=".((string)$_smarty_tpl->tpl_vars['rate_data']->value['rate_id'])), ENT_QUOTES, 'UTF-8');?>
" title="<?php echo $_smarty_tpl->__("delete");?>
"><i class="icon-trash"></i></a>
                                <?php } else { ?>
                                    <span class="icon-trash undeleted-element" <?php echo $_smarty_tpl->__("delete");?>
