<?php /* Smarty version Smarty-3.1.18, created on 2015-06-13 06:21:09
         compiled from "/home/lostus/public_html/sportslinkshop/design/backend/templates/views/upgrade_center/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1221090304557b5b55edc068-46310591%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    '0e3c30b7b7f9e0ed016ce273cdc2167606be74b7' =>
    array (
      0 => '/home/lostus/public_html/sportslinkshop/design/backend/templates/views/upgrade_center/manage.tpl',
      1 => 1418020421,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1221090304557b5b55edc068-46310591',
  'function' =>
  array (
  ),
  'variables' =>
  ...
  'unifunc' => 'content_557b5b561810f9_43114075',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_557b5b561810f9_43114075')) {function content_557b5b561810f9_43114075($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/lostus/public_html/sportslinkshop/app/functions/smarty_plugins/modifier.date_format.php';
if (!is_callable('smarty_modifier_formatfilesize')) include '/home/lostus/public_html/sportslinkshop/app/functions/smarty_plugins/modifier.formatfilesize.php';
...
?><?php
fn_preload_lang_vars(array('upgrade_center.upgrades_are_not_available_in_trial','upgrade_center.filehash_check_failed','note','text_uc_has_conflicts','view','license_number','apply','text_uc_license_number_required','upgrade','version','release_date','filesize','description','package_contents','install','upgrade_is_not_avail','update_period_expired','text_uc_upgrade_needed','file','text_no_upgrades_available','refresh_packages_list','settings','installed_upgrades','installed_upgrades'));
?>
...
" class="input-text-large">
                        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_name'=>"dispatch[upgrade_center.update_settings]",'but_text'=>__("apply"),'but_role'=>"button_main"), 0);?>

                        <p class="muted"><?php echo $_smarty_tpl->__("text_uc_license_number_required",array("[product]"=>@constant('PRODUCT_NAME')));?>
</p>
                    </div>
                </div>
            </form>
...
"/>
                            <?php $_smarty_tpl->_capture_stack[0][] = array("install_btn", null, null); ob_start(); ?>
                                <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_role'=>"submit-link",'but_name'=>"dispatch[upgrade_center.get_upgrade]",'but_target_form'=>"uc_form_".((string)$_smarty_tpl->tpl_vars['package']->value['package_id']),'but_text'=>__("install")), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                    ...
                    <?php } elseif ($_smarty_tpl->tpl_vars['package']->value['purchase_time_limit']=='Y') {?>
                        <span><?php echo $_smarty_tpl->__("upgrade_is_not_avail",array("[product]"=>@constant('PRODUCT_NAME'),"[href]"=>$_smarty_tpl->tpl_vars['config']->value['resources']['helpdesk_url']));?>
</span>
                    <?php } else { ?>
