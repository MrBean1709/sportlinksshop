<?php /* Smarty version Smarty-3.1.18, created on 2015-07-13 12:24:17
         compiled from "/home/lostus/public_html/sportslinkshop/design/backend/templates/addons/1clue_related_products_extended/overrides/views/order_management/components/profiles_info.tpl" */ ?>
<?php /*%%SmartyHeaderCode:990704855a33d71c10c36-75476663%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' =>
  array (
    '51fbaa257fa07b94c2ba36e16ab613b9320f8d1f' =>
    array (
      0 => '/home/lostus/public_html/sportslinkshop/design/backend/templates/addons/1clue_related_products_extended/overrides/views/order_management/components/profiles_info.tpl',
      1 => 1436761328,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '990704855a33d71c10c36-75476663',
  'function' =>
  array (
  ...
  'unifunc' => 'content_55a33d71eef3b4_48780198',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a33d71eef3b4_48780198')) {function content_55a33d71eef3b4_48780198($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/lostus/public_html/sportslinkshop/app/functions/smarty_plugins/block.hook.php';
?><?php
...
<?php $_smarty_tpl->_capture_stack[0][] = array("shipping_address", null, null); ob_start(); ?>
    ...
    <?php if (!fn_is_empty($_smarty_tpl->tpl_vars['user_data']->value)) {?>
        <?php if ($_smarty_tpl->tpl_vars['profile_fields']->value['S']) {?>
            <?php $_smarty_tpl->tpl_vars['self_location_shipping'] = new Smarty_variable('', null, 0);?>
 ...
 $_from = $_smarty_tpl->tpl_vars['user_data']->value['shipping']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                <?php if ($_smarty_tpl->tpl_vars['shipping']->value['module']=="self_collection") {?>
                    <?php $_smarty_tpl->tpl_vars['self_location_shipping'] = new Smarty_variable($_smarty_tpl->tpl_vars['shipping']->value, null, 0);?>
                    <?php break 1?>
                <?php }?>
            <?php } ?>

            <?php if (!empty($_smarty_tpl->tpl_vars['self_location_shipping']->value)) {?>
                <p class="strong">Self Pickup: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['self_location_shipping']->value['shipping'], ENT_QUOTES, 'UTF-8');?>
</p>
                <p>Outlet Name: <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['self_location_shipping']->value['service_params']['outlet_name'])===null||$tmp==='' ? 'none' : $tmp), ENT_QUOTES, 'UTF-8');?>
</p>
                <p>Location: <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['self_location_shipping']->value['service_params']['location'])===null||$tmp==='' ? 'none' : $tmp), ENT_QUOTES, 'UTF-8');?>
</p>
                <p>Address: <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['self_location_shipping']->value['service_params']['address'])===null||$tmp==='' ? 'none' : $tmp), ENT_QUOTES, 'UTF-8');?>
</p>
            <?php } else { ?>
