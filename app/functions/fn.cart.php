...
// EDIT: fireflyinnov
/**
 * create shipment aramex by api
 *
 * @param array $more_info : includes ()
...
function fn_aramex_api_create_shipment ($origination, $location, $aramex_service_params, $more_info) {
    ...
    if (empty($more_info['customer_phone'])) {
        $more_info['customer_phone'] = $origination['phone'];
    }
    ...
    $params = array(
        ...
        'ClientInfo' => array(
            'AccountCountryCode'    => $aramex_service_params['account_country_code'],
            'AccountEntity'         => $aramex_service_params['account_entity'],
            'AccountNumber'         => $aramex_service_params['account_number'],
            'AccountPin'            => $aramex_service_params['account_pin'],
            'UserName'              => $aramex_service_params['username'],
            'Password'              => $aramex_service_params['password'],
            'Version'               => $aramex_service_params['version']
        ),
...
function fn_get_order_info($order_id, $native_language = false, $format_info = true, $get_edp_files = false, $skip_static_values = false)
{
    if (!empty($order_id)) {
        ...
        if (!empty($order)) {
            ...
            if (1 || !fn_allowed_for('ULTIMATE:FREE')) {
...
//
function fn_allow_place_order(&$cart, $auth = null)
{
