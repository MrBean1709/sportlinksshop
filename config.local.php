...
$config['db_name'] = 'lostus_splinkshop';
$config['db_user'] = 'root';
$config['db_password'] = '';
...
$config['http_path'] = '/sportslinkshop';

// Host and directory where software is installed on secure server
$config['https_host'] = 'lostcom.us';
$config['https_path'] = '/sportslinkshop';
